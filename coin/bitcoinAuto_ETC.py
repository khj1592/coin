...
coin_list = ["KRW-ETC"]
coin_list2 = ["KRW-BTT", "KRW-WAVES", "KRW-SXP", "KRW-VET", "KRW-SRM", "KRW-TRX", "KRW-LINK", "KRW-ZRX", "KRW-XRP", "KRW-BTG", "KRW-DAWN", "KRW-EOS", "KRW-FLOW", "KRW-BCH", "KRW-LTC", "KRW-NEO", "KRW-CHZ", "KRW-STPT", "KRW-QTUM", "KRW-STRK", "KRW-ADA", "KRW-BAT", "KRW-POLY"]
